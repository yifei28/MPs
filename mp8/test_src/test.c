...
int main(){
	...
	if( move_s(game_cpy1) == _move_s(game_cpy2))
                printf("test: pass - move_s returns the correct value\n");
        else
                printf("test: fail - move_s returns the incorrect value\n");
	...
	ptr1 = game_cpy1->cells;
        ...
        for( i = 0; i < 12; i ++){
                if (*ptr1 != *ptr2){
                        printf("test: fail - move_s does not move tiles correctly\n");
                        printf("Your output:");
                        print_game(game_cpy1);
                        printf("Correct output:");
                        print_game(game_cpy2);
        ...
        printf("test: pass - move_s moves the tiles around correctly\n");
